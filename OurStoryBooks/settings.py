"""
Django settings for OurStoryBooks project.
...
SECRET_KEY = 'django-insecure-izt+$u@n7&v&(mh-f(hrdybs*6r6t_ee1!@vu3!b1@@dmy!9bh'
...
WSGI_APPLICATION = 'OurStoryBooks.wsgi.application'
...
VNPAY_RETURN_URL = env('VNPAY_RETURN_URL')  # get from config
